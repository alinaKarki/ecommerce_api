...
class CategoryModel(TimeStampModel):
    category_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="category_user", default=None)
...
class Invoice(TimeStampModel):
    ...
    product = models.ForeignKey(ProductsModel, on_delete=models.CASCADE, related_name="invoice_product", default='0', null=True)
    bill_number = models.CharField(max_length=30)
    status = models.PositiveSmallIntegerField(choices=IntergerEnum.choices, default=IntergerEnum.Second)
